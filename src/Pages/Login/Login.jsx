          ...
          <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center ">
            ...
            <div className="md:w-1/2 px-8 md:px-16">
              ...
              >
                ...
                <div>
                  <label>
                    <LoadCanvasTemplate className="my-4" />
                  </label>
                  ...
                  <input
                    ...
                    className="input p-2 rounded-xl border w-full my-2 "
                  />
                </div>
                {/* <div>
                  <Button variant="outlined" onClick={handelvalidateCaptcha}>
                    Validate
                  </Button>
                </div> */}
                <button
                  disabled={disable}
                  className="bg-purple-500 rounded-xl text-white py-2  hover:scale-105 duration-300"
                >
                  Login
                </button>
              </form>
